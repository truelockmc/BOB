...
public class ScenarioSelectMenu extends SelectMenu {
    ...
    private final ButtonGroup scrollGroup = new ButtonGroup(pair -> {
        ...
        Scenario scenario = BOB.getInstance()
            .getScenarioManager()
            .getScenario(id);
    ...
    private final ButtonComp nextMenuButton = new ButtonComp(
        "Next",
        Color.WHITE,
    ...
    private final ButtonComp buttonSoThatItLooksBetter = new ButtonComp(
        "Placeholder",
        Color.WHITE,
        Color.DARK_GRAY.darker(),
        true,
    ...
    public ScenarioSelectMenu(
        ...
        selectedScenario = BOB.getInstance()
            .getScenarioSceneLoader()
            .getCurrentScenario();
    ...
    public void drawImageFrame(Graphics2D g2) {
        ...
        int x = scroller.isCentered()
            ? (scroller.getPanel().getWidth() - bounds.width) / 2
            : bounds.x;
        int y = scroller.isCentered()
            ? (scroller.getPanel().getHeight() - bounds.height) / 2
            : bounds.y;
        ...
        g2.drawImage(
            ImageUtil.makeRoundedCorner(selectedScenario.getMapImage(), 100),
            x + 405,
            y + 40,
            width,
            height,
